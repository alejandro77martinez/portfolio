  ...
  return (
    <div className='flex flex-col items-center p-3 border-t border-gray-300'>
      <p className='flex justify-center items-center '>
        <a rel="cc:attributionURL" href="/">Sitio web&nbsp;</a> realizado por&nbsp;<a rel="cc:attributionURL dct:creator" property="cc:attributionName" href="contact"> Alejandro Martinez&nbsp;</a>bajo una licencia&nbsp; 
